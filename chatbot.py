...
st.markdown("""
<style>
/* Global background — dark navy with subtle grid */
...
.stApp::before {
    ...
    position: fixed;
    inset: 0;
    background: radial-gradient(circle at top, rgba(59,130,246,.20), transparent 55%);
    pointer-events: none;
    z-index: 0;
}
...
h1 {
    ...
    text-shadow: 0 0 25px rgba(99,102,241,.45);
}
...
[data-testid="stChatMessage"] {
    ...
    box-shadow: 0 0 25px rgba(59,130,246,.10), inset 0 0 8px rgba(255,255,255,.03);
    padding: 18px;
    transition: .25s;
}
...
[data-testid="stChatMessage"]:hover {
    ...
    box-shadow: 0 0 35px rgba(59,130,246,.20);
}
